...
public class HouseRobberII {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Math.max(recursion(0, nums1, n-1),recursion(0, nums2, n-1)));
        int dp[] = new int[n-1];
        int dp2[] = new int[n-1];
        System.out.println(Math.max(topDown(n-2, n-1, dp, nums1), topDown(n-2, n-1, dp2, nums2)));
        System.out.println(Math.max(bottomUp(n-1, nums1), bottomUp(n-1, nums2)));
    }
}
